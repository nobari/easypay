          ...
          <IonList lines="none">
            <IonItem>
              ...
              <IonSelect value={location} interfaceOptions={selectOptions} onIonChange={(e) => setLocation(e.detail.value as any)}>
                <IonSelectOption value="madison">Child care</IonSelectOption>
                <IonSelectOption value="austin">Wikipedia</IonSelectOption>
                <IonSelectOption value="chicago">others</IonSelectOption>
              </IonSelect>
            </IonItem>
